---
platform: android
device: smartmirrorpad
language: java
---

Run a simple JAVA sample on SmartMirrorPad running Android(minSdkVersion 21)
===
---
...
This document describes how to connect SmartMirrorPad with Azure IoT SDK. This multi-step process includes:
...
2.  Go to MainActivity.java, replace the [device connection string] placeholder with connection string of the device you have created in Provision your device and get its credentials and save the file. An example of IoT Hub Connection String is as below:
        ...
        DeviceConnectionString=HostName=[YourIoTHubName];DeviceId=[YourDeviceId];SharedAccessKey=[YourAccessKey]
