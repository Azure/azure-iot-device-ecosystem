...
Run a simple C# sample on EM-DMT81H device running Windows 10 Enterprise LTSC
===
---
...
This document describes how to connect EM-DMT81H device running Windows 10 Enterprise LTSC with Azure IoT Edge Runtime pre-installed and Device Management. This multi-step process includes:
...
-   First, you can press and hold the power button for 3 seconds to turn on the device. Of course, you can plug in the adapter to make the device have longer usage time. When the charging light is green, the device is charging.

-   More information about the device is as follows:[EM-DMT81H device](https://www.emdoorrugged.com/em-cdt81/em-cdt81.html) 
