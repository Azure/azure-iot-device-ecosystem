---
platform: windows 10
device: avalue eps-cfs
language: csharp
---

Run a simple Csharp sample on Avalue EPS-CFS device running Windows 10
===
---
...
This document describes how to connect Avalue [EPS-CFS][device-link] device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Avalue [EPS-CFS][device-link] device.
-   VGA Cable,USB Keyboard/Mouse, and the Internet connection

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Connect the power adapter, USB Keyborad/Mouse with Avalue [EPS-CFS][device-link].
...
[device-link]: https://www.avalue.com.tw/products/Industrial-Computer/Embedded-Computer/Fanless-System/EPS-CFS_2789