...
Run a simple Csharp sample on WAD-MX6W device running Windows 10 IoT Core
===
---
...
This document describes how to connect WAD-MX6W device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](http://www.wearedev.net/?mod=wadmx6w).
