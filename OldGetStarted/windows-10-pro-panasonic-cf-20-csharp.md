...
device: panasonic cf-20
language: csharp
---

Run a simple Csharp sample on Panasonic CF-20 device running Windows 10 Pro
===
---
...
This document describes how to connect Panasonic CF-20 device running Windows 10 Pro with Azure IoT SDK. This multi-step process includes:
...
-   Panasonic CF-20 device.

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   You will need to have the Panasonic CF-20 configured with Setting to be on Developer Mode. Please refer [here](https://docs.microsoft.com/en-us/windows/uwp/get-started/enable-your-device-for-development) for details.
