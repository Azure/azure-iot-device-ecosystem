...
device: diagramics infostick
language: csharp
---

Run a simple Csharp sample on Diagramics InfoStick&trade; device running Windows 10 IoT Core
===
---
...
This document describes how to connect Diagramics InfoStick&trade; device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
...
-   Diagramics InfoStick&trade; device.
...
-   A computer monitor or Smart TV with HDMI input

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Follow the instructions [here](http://www.diagramics.com/Products/InfoStick)
