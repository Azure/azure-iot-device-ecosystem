...
Run a simple C sample on MIC device family running Linux
===
---
...
**About this document**
This document describes how to connect MIC device family running Linux with Azure IoT SDK. This multi-step process includes:
