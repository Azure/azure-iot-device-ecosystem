...
Run a simple Csharp sample on MC-1100 device running Windows 10 IoT Core
===
---
...
This document describes how to connect MC-1100 device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
