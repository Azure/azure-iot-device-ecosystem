...
-   Make sure **SE-8124** is ready as per instructions given on [Prepare your development environment](https://github.com/Azure/azure-iot-sdk-csharp/blob/master/device/doc/devbox_setup.md#prerequisites)
