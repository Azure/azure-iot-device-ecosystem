...
Run a simple Csharp sample on MV-H29SAG device running Windows Server 2016 Standard
===
---
...
This document describes how to connect MV-H29SAG device running Windows Server 2016 Standard with Azure IoT SDK. This multi-step process includes:
...
-   Connect to Internet.
-   Installation "Visual Studio 2015" and "Azure SDK for .NET" to MV-H29SAG.
