...
Run a simple C sample on NET170AS7-PC device running Windows 10 IoT Enterprise LTSB
===
---
...
This document describes how to connect NET170AS7-PC device running Windows 10 IoT Enterprise LTSB with Azure IoT SDK. This multi-step process includes:
...
-   Turn on your NET170AS7-PC device and connect to internet
...
-   Locate the following code in the file:
        ...
        static const char* connectionString = "HostName=NET170AS7-PC.azure-devices.net;DeviceId=NET170AS7-PC;SharedAccessKey=+LPi95/qzaBuS7MYihAvkcH1u9EJ1JHUJl6THPqKRs4=";
