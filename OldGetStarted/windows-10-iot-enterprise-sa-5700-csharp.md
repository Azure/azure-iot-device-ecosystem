...
Run a simple Csharp sample on SA-5700 device running Windows 10 IoT Enterprise
===
---
...
This document describes how to connect SA-5700 device running Windows 10 IoT Enterprise with Azure IoT SDK. This multi-step process includes:
...
-   Power on SA-5700 (Windows 10 Enterprise).
...
-   Connect the SA-5700 to your network using an Ethernet cable. This step is required, as the sample depends on internet access
