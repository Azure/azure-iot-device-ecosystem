...
Run a simple PYTHON sample on Tibbo-Pi device running raspbian
===
---
...
-   Install the prerequisite packages for the Microsoft Azure IoT Device SDK for Python by issuing the following commands from the command line on your board:
        ...
        sudo apt-get install -y curl libcurl4-gnutls-dev build-essential cmake git python2.7-dev libboost-python-dev uuid-dev
