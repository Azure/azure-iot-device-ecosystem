...
Run a simple C sample on ADAM-3600 device running Embedded Linux built with Ubuntu14.04
===
...
This document describes how to connect ADAM-3600 device running {enter the OS name running on device} with Azure IoT SDK. This multi-step process includes:
