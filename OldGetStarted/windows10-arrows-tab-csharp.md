...
Run a simple Csharp sample on ARROWS Tab device running Windows 10
===
---
...
This document describes how to connect **ARROWS Tab** device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Make sure **ARROWS Tab** is ready as per instructions given on [Prepare your development environment][devbox-setup].
