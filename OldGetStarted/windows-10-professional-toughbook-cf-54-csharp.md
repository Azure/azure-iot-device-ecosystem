...
device: toughbook cf-54
language: csharp
---

Run a simple Csharp sample on Toughbook CF-54 device running Windows 10 Professional
===
---
...
This document describes how to connect Toughbook CF-54 device running Windows 10 Professional with Azure IoT SDK. This multi-step process includes:
...
-   Toughbook CF-54 device.

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-  You will need to have the Panasonic CF-54 configured with Setting to be on Developer Mode. Please refer [here](https://docs.microsoft.com/en-us/windows/uwp/get-started/enable-your-device-for-development) for details.
