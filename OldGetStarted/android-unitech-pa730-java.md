---
platform: android
device: unitech-pa730
language: java
---

Run a simple JAVA sample on unitech PA730 running Android
===
---
...
This document describes how to connect unitech PA730 with Azure IoT SDK. This multi-step process includes:
