...
Run a simple C sample on QNAP TS-251A device running linux
===
---
...
This document describes how to connect QNAP TS-251A device running linux with Azure IoT SDK. This multi-step process includes:
...
-   QNAP TS-251A device.
-   Connect QNAP TS-251A and your computer to internet

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Install the latest Container Station on your TS-251A by following the instructions in the ["How to use Container Station?"](https://www.qnap.com/en/how-to/tutorial/article/how-to-use-container-station).
