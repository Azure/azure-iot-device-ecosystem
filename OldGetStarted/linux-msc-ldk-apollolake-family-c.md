...
Run a simple C sample on an ApolloLake family device with Linux MSC-LDK
===
---
...
This document describes how to connect the ApolloLake device running MSC-LDK with Azure IoT SDK. This multi-step process includes:
...
-   The Microsoft Azure IoT Device SDK for C is already installed in the standard images as the package "azure-iot-sdk".
...
[lnk-user-manual]: http://www.msc-technologies.eu/de/support/boards.html
