...
Run a simple PYTHON sample on MyPi Industrial IoT Edge Gateway device running Raspbian
===
---
...
This document describes how to connect MyPi Industrial IoT Edge Gateway device running Raspbian with Azure IoT SDK. This multi-step process includes:
...
-   Required hardware:
    -   [MyPi Industrial IoT Edge Gateway](https://www.embeddedpi.com/edge-gateway)
...
-   Run the sample application using the following command:
    ...
    **For AMQP protocol:**
        ...
        python iothub_client_sample.py -u amqp

    **For HTTP protocol:**

        python iothub_client_sample.py -u http

    **For MQTT protocol:**

        python iothub_client_sample.py -h mqtt
