...
device: aaeon-up-xtreme
language: c
---

Run a simple C sample on AAEON-UP-XTREME device running Ubuntu 18.04
===
---
...
This document describes how to connect AAEON-UP-XTREME device running Ubuntu 18.04 with Azure IoT Edge Runtime pre-installed and Device Management. This multi-step process includes:
...
-   AAEON-UP-XTREME device.

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   please refer the link to setup your device <https://wiki.up-community.org/Setup#Setup_guides>
