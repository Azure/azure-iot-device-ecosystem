...
Run a simple Csharp sample on EPC device family running Windows 10 IoT Enterprise LTSB
===
---
...
This document describes how to connect EPC device running Windows 10 IoT Enterprise LTSB with Azure IoT SDK. This multi-step process includes:
