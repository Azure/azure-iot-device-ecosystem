...
Run a simple C sample on AirREAL-Gemini device running Debian 8
===
---
...
This document describes how to connect AirREAL-Gemini device running Debian 8 with Azure IoT SDK. This multi-step process includes:
