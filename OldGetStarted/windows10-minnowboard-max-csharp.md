---
platform: Windows 10
device: minnowboard max
language: csharp
---
Run a simple Csharp sample on MinnowBoard MAX device running Windows 10
===
---
...
This document describes how to connect **MinnowBoard MAX** device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](http://wiki.minnowboard.org/MinnowBoard_MAX).
