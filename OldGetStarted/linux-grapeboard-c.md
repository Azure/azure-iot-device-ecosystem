...
Run a simple C sample on Grapeboard device running Linux
===
---
...
This document describes how to connect Grapeboard device running Linux with Azure IoT SDK. This multi-step process includes:
...
-   Remove shared objects that interfere with openssl.

        rm /usr/local/lib/libssl.*
        rm /usr/local/lib/libcrypto.*
