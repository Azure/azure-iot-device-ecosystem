---
platform: windows 10
device: avalue oft-1202
language: csharp
---

Run a simple Csharp sample on Avalue OFT-1202 device running Windows 10
===
---
...
This document describes how to connect Avalue [OFT-1202][device-link] device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Avalue [OFT-1202][device-link] device.
-   VGA Cable,USB Keyboard/Mouse, and the Internet connection

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Connect the power adapter, USB Keyborad/Mouse with Avalue [OFT-1202][device-link].
...
[device-link]: https://www.avalue.com.tw/products/Panel-PC/Open-Frame-Panel-PC/Open-Frame-Panel-PC/OFT-1202_2603