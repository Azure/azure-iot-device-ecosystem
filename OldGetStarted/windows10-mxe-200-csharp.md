...
language: csharp
---
Run a simple Csharp sample on MXE-200 device running Windows 10
===
---
...
This document describes how to connect **MXE-200** device running Windows 10 with Azure IoT SDK. This multi-step process includes:
