...
Run a simple python sample on EAC PRO-IK90 device running Windows 10 IoT Enterprise
===
---
...
This document describes how to connect EAC PRO-IK90 device running Windows 10 IoT Enterprise with Azure IoT SDK. This multi-step process includes:
...
-   Open the file **iothub\_client\_sample_amqp.py**, **iothub\_client\_sample\_http.py** or  **iothub\_client\_sample_mqtt.py** in a text editor.
