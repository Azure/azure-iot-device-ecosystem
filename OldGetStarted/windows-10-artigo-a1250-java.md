...
Run a simple JAVA sample on ARTiGO-A1250 device running Windows 10 IoT Enterprise
===
---
...
This document describes how to connect ARTiGO-A1250 device running Windows 10 IoT Enterprise with Azure IoT SDK. This multi-step process includes:
...
-   Register your device on [Device Explorer](https://github.com/Azure/azure-iot-sdk-csharp/blob/master/tools/DeviceExplorer/readme.md)
...
3.  You can verify that the environment variables necessary to run Maven 3 have been set correctly by restarting your console and running `mvn --version.`
