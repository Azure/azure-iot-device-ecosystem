---
platform: android
device: unitech ea602
language: java
---

Run a simple JAVA sample on unitech EA602 running Android
===
---
...
This document describes how to connect unitech EA602 with Azure IoT SDK. This multi-step process includes:
