...
Run a simple C sample on Dell Edge Gateway 3003 device running Ubuntu Core 16.04
===
---
...
This document describes how to connect Dell Edge Gateway 3003 device running Ubuntu Core 16.04 with Azure IoT SDK. This multi-step process includes:
