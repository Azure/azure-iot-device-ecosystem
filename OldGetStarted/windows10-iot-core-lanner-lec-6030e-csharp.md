...
device: lanner lec-6030e
language: csharp
---
Run a simple Csharp sample on Lanner LEC-6030E device running Windows 10 IoT Core
===
---
...
This document describes how to connect Lanner LEC-6030E device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
...
-   Since LEC-6030E is a headless device, a VGA header cable is needed to connect to VGA pin head on LEC-6030E motherboard. 
