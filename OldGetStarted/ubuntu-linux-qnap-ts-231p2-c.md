...
device: qnap ts-231p2
language: c
---

Run a simple C sample on QNAP TS-231P2 device running ubuntu linux
===
---
...
This document describes how to connect QNAP TS-231P2 device running ubuntu linux with Azure IoT SDK. This multi-step process includes:
...
-   QNAP TS-231P2 device.
-   Connect QNAP TS-231P2 and your computer to internet

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Install the latest Container Station on your TS-231P2 by following the instructions in the ["How to use Container Station?"](https://www.qnap.com/en/how-to/tutorial/article/how-to-use-container-station).
...
-   Find nearby "Console" on container station website and click icon to enter terminal.

-   Install the prerequisite packages for the Microsoft Azure IoT Device SDK for C by issuing the following commands from the command line on your board:

        apt update
        apt install -y curl libcurl4-openssl-dev uuid-dev uuid g++ make cmake git unzip openjdk-8-jre libssl-dev
