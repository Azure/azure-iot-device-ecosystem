...
Run a simple C sample on WTA-350 device running Windows Embedded 8.1 Industry Pro
===
---
...
This document describes how to connect WTA-350 device running Windows Embedded 8.1 Industry Pro with Azure IoT SDK. This multi-step process includes:
...
-   Turn on your WTA-350 device and connect to internet
...
-   Locate the following code in the file:
        ...
        static const char* connectionString = "HostName=WITEK-IoTHub.azure-devices.net;DeviceId=WTA-350;... ";
