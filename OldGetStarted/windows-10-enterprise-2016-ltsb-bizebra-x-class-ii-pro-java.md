...
Run a simple JAVA sample on Bizerba X-Class II Pro device running Windows 10 Enterprise 2016 LTSB
===
---
...
This document describes how to connect Bizerba X-Class II Pro device running Windows 10 Enterprise 2016 LTSB with Azure IoT SDK. This multi-step process includes:
...
-   Windows 10 Enterprise 2016 LTSB is already pre-installed 
...
3.  Run the following commands on device in sequence to build Azure IoT SDK.
        ...
        mvn install >..\JavaSDK_Build_Logs.txt

4.  Above command will generate the compiled JAR files with all dependencies. This bundle can be found at:

        azure-iot-sdk-java\device\iothub-java-client\target\iothub-java-client-{version}-with-deps.jar
...
-   Navigate to the folder containing the executable JAR file for send event sample.
        ...
        cd azure-iot-sdk-java\device\iot-device-samples\samples\send-event\target
...
-   Navigate to the folder containing the executable JAR file for the receive message sample.
        ...
        cd azure-iot-sdk-java\device\samples\handle-messages\target
