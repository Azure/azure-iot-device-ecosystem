---
platform: linux tegra-ubuntu 4.4.38-tegra
device: cloudian ai box
language: python
---

Run a simple PYTHON sample on CLOUDIAN AI BOX device running Linux tegra-ubuntu 4.4.38-tegra
===
---
...
This document describes how to connect CLOUDIAN AI BOX device running Linux tegra-ubuntu 4.4.38-tegra with Azure IoT SDK. This multi-step process includes:
...
-   [CLOUDIAN AI BOX device][link-cloudian-ai-box]

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   [JectPack3.1 Installation-Flushing Device Tutorial (PDF)][link-JectPack]

  * Above steps are done before delivering the AI Box. They are neede only if you want to flush (re-initialize) the device. Please proceed to Step 3 for the first time.
...
[link-cloudian-ai-box]: http://www.cloudian-ai.com/ai-box/
[link-JectPack]: http://www.cloudian-ai.com/img/ai-box/jectPack3.1%20Installation-Flushing%20Device%20Tutorial.pdf
