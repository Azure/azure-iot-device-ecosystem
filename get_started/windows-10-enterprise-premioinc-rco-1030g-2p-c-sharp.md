...
device: rco-1030g-2p gpu computer
language: csharp
---

Run a simple Csharp sample on RCO-1030G-2P Rugged Edge Computer device running Windows 10 Enterprise LTSC
===
---
...
This document describes how to connect RCO-1030G-2P Rugged Edge Computer device running Windows 10 Enterprise LTSC with Azure IoT SDK. This multi-step process includes:
...
-   RCO-1030G-2P Rugged Edge Computer device.
