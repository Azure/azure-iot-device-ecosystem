...
Run a simple Csharp sample on MPT-3000RSM device running Windows 10
===
---
...
This document describes how to connect MPT-3000RSM device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
# Install Windows 10 Enterprise LTSB on MPT-3000RSM
...
-   Insert the bootable USB Drive from the previous step into your MPT-3000RSM. Turn on your MPT-3000RSM device and press the  **Delete**  key.
-   Change the BIOS Boot option filter to **Boot**.
-   Change the **Boot Option Priorities**  to boot from your USB Drive.
-   Save changes and restart your MPT-3000RSM. Follow on screen instructions to install Windows Operating System on your MPT-3000RSM.
