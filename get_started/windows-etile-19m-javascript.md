...
device: etile 19m-fkb
language: java-script
---

Run a simple java-script sample on eTILE 19M-FKB device running Windows Server 2019
===
---
...
This document describes how to connect eTILE 19M-FKB device running Windows Server 2019 with Azure IoT Edge Runtime pre-installed and Device Management. This multi-step process includes:
