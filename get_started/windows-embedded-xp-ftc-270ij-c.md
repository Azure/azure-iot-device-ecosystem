---
platform: windows embedded xp
device: ftc-270ij
language: c
---

Run a simple C sample on FTC-270IJ device running Windows Embedded XP
===
---
...
This document describes how to connect FTC-270IJ device running Windows Embedded XP with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](http://www.fastsystems.kr/wanee/bbs/board.php?bo_table=z2_2&wr_id=16).
