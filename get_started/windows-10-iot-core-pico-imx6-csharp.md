...
Run a simple Csharp sample on PICO-IMX6 device running Windows 10 IOT Core
===
---
...
This document describes how to connect PICO-IMX6 device running Windows 10 IOT Core with Azure IoT SDK. This multi-step process includes:
...
-   Turn on PICO-IMX6 and connect to Internet
