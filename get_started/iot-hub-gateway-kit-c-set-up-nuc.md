...
- Run a "hello_world" sample application on the Intel NUC to verify the gateway functionality.
  ...
  > If you have any problems, look for solutions on the [troubleshooting page](https://github.com/Microsoft/azure-docs/blob/master/articles/iot-hub/iot-hub-gateway-kit-c-troubleshooting.md).
...
![Gateway Kit](media/iot-hub-gateway-kit-c-set-up-nuc/kit.png)
...
![Intel NUC connected to peripherals](media/iot-hub-gateway-kit-c-set-up-nuc/nuc.png)
...
2. Get the IP address of the Intel NUC by running the `ifconfig` command on the Intel NUC device.
   ...
   ![ifconfig output showing Intel NUC IP](media/iot-hub-gateway-kit-c-set-up-nuc/ifconfig.png)
...
3. Use one of the following SSH clients from your host computer to connect to Intel NUC.
   ...
   ![SSH client running on macOS](media/iot-hub-gateway-kit-c-set-up-nuc/ssh.png)
...
1. Add the IoT Cloud repository by running the following commands in a terminal window:
   ...
   ![rpm and smart channel commands output](media/iot-hub-gateway-kit-c-set-up-nuc/rpm_smart_channel.png)
...
![application output](media/iot-hub-gateway-kit-c-set-up-nuc/hello_world.png)
...
![log.txt directory view](media/iot-hub-gateway-kit-c-set-up-nuc/logtxtdir.png)
...
![log.txt directory view](media/iot-hub-gateway-kit-c-set-up-nuc/logtxtview.png)
...
## Next steps
[Use an IoT gateway to connect a device to Azure IoT Hub](https://github.com/Microsoft/azure-docs/blob/master/articles/iot-hub/iot-hub-gateway-kit-c-iot-gateway-connect-device-to-cloud.md)
