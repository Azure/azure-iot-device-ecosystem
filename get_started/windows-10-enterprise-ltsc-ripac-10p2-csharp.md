...
Run a simple C# sample on RIPAC-10P2 device running Windows 10 Enterprise LTSC
===
---
...
This document describes how to connect RIPAC-10P2 device running Windows 10 Enterprise with Azure IoT Edge Runtime pre-installed and Device Management. This multi-step process includes:
