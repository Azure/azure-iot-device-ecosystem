...
Run a simple python sample on ASUS Tinker Edge T device running Debian Linux
===
---
...
This document describes how to connect ASUS Tinker Edge T device running Debian Linux with Azure IoT SDK. This multi-step process includes:
...
-   [Debian Linux image (Mendel OS)][lnk-mendel-os-dl]

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Update image on ASUS Tinker Edge T device
-   Connect to internet with Ethernet or Wi-Fi
...
-   Open the file **iothub\_client\_sample\_mqtt.py** in a text editor.
...
[lnk-mendel-os-dl]: [https://www.asus.com/AIoT-Industrial-Solutions/Tinker-Edge-T/HelpDesk_Download/](https://www.asus.com/AIoT-Industrial-Solutions/Tinker-Edge-T/HelpDesk_Download/)