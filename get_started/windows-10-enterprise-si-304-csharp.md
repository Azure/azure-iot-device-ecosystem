...
Run a simple Csharp sample on si-304 device running windows 10 enterprise
===
---
...
This document describes how to connect si-304 device running windows 10 enterprise with Azure IoT SDK. This multi-step process includes:
...
-   Install Windows 10 Enterprise LTSB on SI-304
    ...
    - Insert the bootable USB Drive from the previous step into your SI-304. Turn on your SI-304 device and press the Delete key.
    - Change the BIOS Boot option filter to “Boot”.
    - Change the “Boot Option Priorities” to boot from your USB Drive.
    - Save changes and restart your SI-304. Follow on screen instructions to install Windows Operating System on your SI-304.
...
-   Install Windows 10 Enterprise LTSB on SI-304
    ...
    - Install any version of [Visual Studio 2015](https://www.visualstudio.com/downloads/download-visual-studio-vs.aspx). Select components
