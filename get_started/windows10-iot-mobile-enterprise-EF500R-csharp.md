...
language: csharp
---
Run a simple Csharp sample on EF500R device running Windows 10 IoT Mobile Enterprise
===
---
...
This document describes how to connect EF500R device running Windows 10 IoT Mobile Enterprise with Azure IoT SDK. This multi-step process includes:
...
-   EF500R (Windows 10 IoT Mobile Enterprise).
-   Micros USB
