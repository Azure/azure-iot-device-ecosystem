...
Run a simple Csharp sample on MPC-2070 device running Windows 10 IOT Core
===
---
...
This document describes how to connect MPC-2070 device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions [here](http://www.moxa.com/product/Marine_Computers.htm).
