...
Run a simple JAVA sample on Grapebaord device running Linux
===
---
...
This document describes how to connect Grapeboard device running Java with Azure IoT SDK. This multi-step process includes:
...
-   Navigate to the folder containing the executable JAR file for send event sample (assuming you are at **azure-iot-sdk-java/device** ).

        cd iot-device-samples/send-event/target
...
-   Navigate to the folder containing the executable JAR file for the receive message sample (assuming you are at **azure-iot-sdk-java/device** ).

        cd iot-device-samples/handle-messages/target
