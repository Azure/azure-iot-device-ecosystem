...
Run a simple Csharp sample on BTE device running Windows 10
===
---
...
-   Open the **samples.sln** solution in the `iothub\device\samples` folder in your local copy of the repository.
