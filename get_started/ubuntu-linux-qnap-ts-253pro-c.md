...
device: qnap ts-253pro
language: c
---

Run a simple C sample on QNAP TS-253Pro device running Ubuntu Linux
===
---
...
This document describes how to connect QNAP TS-253Pro device running Ubuntu Linux with Azure IoT SDK. This multi-step process includes:
...
-   QNAP TS-253Pro device.
-   Connect QNAP TS-253Pro and your computer to internet

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Install the latest Container Station on your QNAP TS-253Pro by following the instructions in the ["How to use Container Station?"](https://www.qnap.com/en/how-to/tutorial/article/how-to-use-container-station).
