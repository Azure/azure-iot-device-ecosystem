...
Run a simple Csharp sample on NISE 50W device running Windows 10 IoT Core
===
---
...
This document describes how to connect NISE 50W device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
