---
platform: android
device: unitech hg700
language: java
---

Run a simple JAVA sample on unitech HG700 running Android
===
---
...
This document describes how to connect unitech HG700 with Azure IoT SDK. This multi-step process includes:
