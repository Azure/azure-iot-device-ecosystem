...
Run a simple Csharp sample on NEC FC-E22U device running Windows 10 IoT Enterprise
===
---
...
This document describes how to connect NEC FC-E22U device running Windows 10 IoT Enterprise with Azure IoT SDK. This multi-step process includes:
...
-  You will need to have the NEC FC-E22U configured with Setting to be on Developer Mode. Please refer [here](https://docs.microsoft.com/en-us/windows/uwp/get-started/enable-your-device-for-development) for details.
