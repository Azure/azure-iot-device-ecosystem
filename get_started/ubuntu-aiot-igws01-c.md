...
Run a simple C sample on AIOT-IGWS01 device running Ubuntu 16.04.2
===
---
...
This document describes how to connect AIOT-IGWS01 device running Ubuntu 16.04.2 with Azure IoT SDK. This multi-step process includes:
...
-   Enter AIOT-IGWS01 product page(http://www.aaeon.com/en/p/iot-gateway-systems-aiot-igws01) download manual and start AIOT-IGWS01 follow the instructions and install the Linux operating system.
