...
Run a simple Csharp sample on KUBER-2110 device running Windows 10
===
---
...
This document describes how to connect KUBER-2110 device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](http://www.mitwell.com.tw/)
...
-   Enter **Azure IoT Certification Service** in [here](https://aics.azureiotsolutions.com/), Step 3 "Select and test capabilities" to see Received messages from the device.
