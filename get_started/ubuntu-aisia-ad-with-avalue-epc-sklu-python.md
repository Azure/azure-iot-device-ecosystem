...
This document describes how to connect AISIA-AD with Avalue-EPC-SKLU device running Ubuntu16.04 with Azure IoT SDK. This multi-step process includes:
...
-   Install Camera driver and setup to your requirements.
-   Install according to the camera manufacturer's instructions.


    **NET (New Electronic Technology) :**

-   [NET 3iCube - USB3.0](https://net-gmbh.com/jp/USB3.0.html#BC11000BU)
