---
platform: debian 8 linux
device: ebox336x series
language: python
---

Run a simple PYTHON sample on EBOX336x series device running Debian 8 Linux
===
---
...
This document describes how to connect EBOX336x series device running Debian 8 Linux with Azure IoT SDK. This multi-step process includes:
...
-   EBOX336x series device

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Install Debian 8 on your device.
