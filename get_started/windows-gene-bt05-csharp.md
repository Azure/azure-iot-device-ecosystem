...
Run a simple Csharp sample on GENE-BT05 device running Windows 10
===
---
...
This document describes how to connect GENE-BT05 device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Enter GENE-BT05 product page(http://www.aaeon.com/en/p/3-and-half-inches-subcompact-boards-gene-bt05/) download manual and start GENE-BT05 follow the instructions and install the Windows10 operating system.
