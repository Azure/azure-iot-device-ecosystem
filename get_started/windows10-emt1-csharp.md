...
Run a simple Csharp sample on EMT1 device running Windows 10
===
---
...
This document describes how to connect EMT1 device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](http://info.emdoor.com/Custom_Products.asp?ID=54&amp;nav=2).
