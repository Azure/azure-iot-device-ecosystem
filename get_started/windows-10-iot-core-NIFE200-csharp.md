...
Run a simple Csharp sample on NIFE200 device running Windows 10 IOT Core
===
---
...
This document describes how to connect NIFE200 device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
