...
Run a simple Csharp sample on ACP-1104 device running Windows 10
===
---
...
This document describes how to connect ACP-1104 device running Windows 10 with Azure IoT SDK. This multi-step process includes:
