...
Run a simple Csharp sample on Keith & Koep MyonI device running Windows 10 IOT Core
===
---
...
This document describes how to connect Myon I device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
...
-   [Keith & Koep dragonBase - Myon I carrierboard](http://keith-koep.com/en/products/products-baseboards/dragonbase-myon-snapdragon410-baseboard-technical-data/)

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Follow the instructions [here](http://support.keith-koep.com/service/doku.php/service/hardware/module/myon1)
