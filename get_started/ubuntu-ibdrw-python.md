...
Run a simple PYTHON sample on IBDRW device running Ubuntu 18.04
===
---
...
This document describes how to connect IBDRW device running Ubuntu 18.04 with Azure IoT SDK. This multi-step process includes:
