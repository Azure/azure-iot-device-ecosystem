...
Run a simple C sample on SIM7600E device running Linux
===
---
...
This document describes how to connect SIM7600E device running Linux with Azure IoT SDK. This multi-step process includes:
...
-   SIM7600E is 4G Module device which should  work with MCU. The config to connet with device depens on the OS of diffrent MCU. So please [Contact us](http://www.simcomm2m.com/).
