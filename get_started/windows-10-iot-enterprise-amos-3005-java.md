...
Run a simple JAVA sample on AMOS-3005 device running Windows 10 IoT Enterprise
===
---
...
This document describes how to connect AMOS-3005 device running Windows 10 IoT Enterprise with Azure IoT SDK. This multi-step process includes:
