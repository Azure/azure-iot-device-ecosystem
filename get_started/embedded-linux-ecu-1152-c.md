...
Run a simple C sample on ECU-1152 device running Embedded Linux built with Ubuntu14.04
===
...
This document describes how to connect ECU-1152 device running Embedded Linux with Azure IoT SDK. This multi-step process includes:
...
-   Connect the ECU-1152 device to the network,then open the TagLink Stutio software to search the device's ip address.
...
-   Copy the *iothub\_client\_sample\_mqtt file* to ECU-1152 device.
