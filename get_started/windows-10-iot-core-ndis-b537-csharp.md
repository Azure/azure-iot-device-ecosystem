...
Run a simple Csharp sample on NDiS B537 device running Windows 10 IoT Core
===
---
...
This document describes how to connect NDiS B537 device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
