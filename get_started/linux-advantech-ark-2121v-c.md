...
Run a simple C sample on ARK-2121V  running Linux
===
---
...
This document describes how to connect **ARK-2121V** device running **linux** with Azure IoT SDK. This multi-step process includes:
