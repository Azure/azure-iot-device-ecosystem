...
device: aimb device family
language: csharp
---

Run a simple Csharp sample on AIMB device family running Windows 10 IoT Enterprise LTSB
===
---
...
This document describes how to connect AIMB device running Windows 10 IoT Enterprise LTSB with Azure IoT SDK. This multi-step process includes:
