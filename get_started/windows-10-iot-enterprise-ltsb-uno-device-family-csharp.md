...
device: uno device family
language: csharp
---

Run a simple Csharp sample on UNO device family running Windows 10 IoT Enterprise LTSB
===
---
...
This document describes how to connect UNO device running Windows 10 IoT Enterprise LTSB with Azure IoT SDK. This multi-step process includes:
