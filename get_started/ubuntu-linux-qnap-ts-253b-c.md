...
Run a simple C sample on QNAP TS-253B device running Ubuntu Linux 16.04
===
---
...
This document describes how to connect QNAP TS-253B device running Ubuntu Linux 16.04 with Azure IoT SDK. This multi-step process includes:
...
-   QNAP TS-253B device.
-   Connect QNAP TS-253B and your computer to internet

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Install the latest Container Station on your TS-253B by following the instructions in the ["How to use Container Station?"](https://www.qnap.com/en/how-to/tutorial/article/how-to-use-container-station).
...
-   Click "Terminal" button and key in "bash" in your ubuntu 16.04 container to enter terminal.
