...
Run a simple Csharp sample on Keith&Koep Trizeps7 based device running Windows 10 IoT Core
===
---
...
This document describes how to connect Keith&Koep Trizeps7 device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
...
-   [Keith&Koep-Trizeps7](https://keith-koep.com/en/products/products-trizeps/trizeps-vii-features)

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Follow the instructions [here](https://support.keith-koep.com/service/doku.php/service/hardware/module/trizeps7)
