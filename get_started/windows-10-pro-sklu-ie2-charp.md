...
Run a simple Csharp sample on SKLU-IE2 device running Windows 10 Pro
===
---
...
This document describes how to connect SKLU-IE2 device running Windows 10 Pro with Azure IoT SDK. This multi-step process includes:
...
-   Connect Ethernet cable to the WAN port on SKLU-IE2 device and connect the other end to your switch/hub/router.
-   Connect a USB Keyboard and Mouse to the back USB ports of your SKLU-IE2 device. Using an VGA cable, also connect a monitor to the device.
