...
Run a simple PYTHON sample on AirREAL-MV device running Debian 8
===
---
...
This document describes how to connect AirREAL-MV device running Debian 8 with Azure IoT SDK. This multi-step process includes:
...
-   AirREAL-MV device with Debian 8.
-   Ethernet cable.
-   SSH client on your computer, such as PuTTY, so you can remotely access the command line on the AirREAL-MV.
<a name="PrepareDevice"></a>
# Step 2: Prepare your Device
-   Follow the instructions on the [support page](http://www.mi-j.co.jp/support) site to set up your AirREAL-MV device and connect it to your computer.
-   Connect your AirREAL-MV to your network using an ethernet cable or insert SIM into AirREAL-MV and connect to the LTE network.
