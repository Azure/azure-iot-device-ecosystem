...
Run a simple PYTHON sample on NDIS B537 device running Ubuntu Server 18.04.1
===
---
...
This document describes how to connect NDIS B537 device running Ubuntu Server 18.04.1 with Azure IoT SDK. This multi-step process includes:
...
-   Install the prerequisite packages for the Microsoft Azure IoT Device SDK for Python by issuing the following commands from the command line on your board:
        ...
        sudo apt install -y curl libcurl4-openssl-dev build-essential cmake git python2.7-dev libboost-python-dev
