...
Run a simple Csharp sample on RFID Tunnel device running Windows 10
===
---
...
This document describes how to connect RFID Tunnel device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](http://www.componentsoft.com/).
