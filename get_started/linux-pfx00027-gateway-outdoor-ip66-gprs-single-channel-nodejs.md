---
platform: linux
device: pfx00027 gateway outdoor ip66 gprs single channel
language: node
---

Run a simple JavaScript sample on PFX00027 GATEWAY OutDoor IP66 GPRS single channel device running Linux
===
---
...
This document describes how to connect PFX00027 GATEWAY OutDoor IP66 GPRS single channel device running Linux with Azure IoT SDK. This multi-step process includes:
...
-   PFX00027 GATEWAY OutDoor IP66 GPRS single channel device.
-   Computer with Git client installed 
-   NodeJS as runtime framework according to Azure IoT SDK requirements.

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device
Be sure to have installed the recommended version of NodeJS (8.x). To check if node is available tyepe the following command:

    node --version

If NodeJS is not installed do the following:

    curl -sL https://deb.nodesource.com/setup_8.x | sudo bash -

    sudo apt-get install -y nodejs

If you have an older version of NodeJS first remove it and then install the expected version.
