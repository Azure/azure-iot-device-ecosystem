...
Run a simple C sample on AIM device family running Linux
===
---
...
This document describes how to connect AIM device family running Linux with Azure IoT SDK. This multi-step process includes:
