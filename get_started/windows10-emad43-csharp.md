...
Run a simple Csharp sample on EMAD43 device running Windows 10
===
---
...
This document describes how to connect EMAD43 device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](http://info.emdoor.com/Custom_Products.asp?ID=69&amp;nav=2).
