---
platform: ubuntu linux 16.04.2
device: up-squared
language: c
---

Run a simple C sample on UP-Squared device running Ubuntu Linux 16.04.2
===
---
...
This document describes how to connect UP-Squared device running Ubuntu Linux 16.04.2 with Azure IoT SDK. This multi-step process includes:
...
-   Enter UP-Squared product page <http://www.aaeon.com/en/p/iot-gateway-maker-boards-up-squared> download manual and start UP-Squared follow the instructions and install the Linux operating system.
