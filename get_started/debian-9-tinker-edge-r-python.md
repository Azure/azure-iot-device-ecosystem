...
Run a simple python sample on ASUS Tinker Edge R device running Debian 9
===
---
...
This document describes how to connect ASUS Tinker Edge R device running Debian 9 with Azure IoT SDK. This multi-step process includes:
...
- Update image on ASUS Tinker Edge R device
