...
Run a simple PYTHON sample on IGT-33V device running Debian 9
===
---
...
This document describes how to connect IGT-33V device running debian with Azure IoT SDK. This multi-step process includes:
...
-   Follow the [instruction](http://www.automation.iiot.tw/en/unbox-neousys-iot-gateway-igt20/connect-to-igt-20-via-console-port) to log in to IGT-33V
