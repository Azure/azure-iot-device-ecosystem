...
Run a simple C sample on FR900 device running buildroot 4.14.73-linux4sam_6.0
===
---
...
This document describes how to connect FR900 device running buildroot 4.14.73-linux4sam_6.0 with Azure IoT SDK. This multi-step process includes:
...
-   Turn on the FR900 device and Connect the LAN cable to activate the Internet..
