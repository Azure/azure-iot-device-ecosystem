...
device: hpe edgeline el300
language: csharp
---

Create and configure an Azure IoT Edge device using an HPE EL300 running an Azure IoT Edge supported [Tier 1 OS][lnk-edge-support]
===
---
...
This document describes how to configure an HPE Edgeline EL300 running an Azure IoT Edge supported [Tier 1 OS][lnk-edge-support] with the Azure IoT Edge Runtime. This multi-step process includes:
