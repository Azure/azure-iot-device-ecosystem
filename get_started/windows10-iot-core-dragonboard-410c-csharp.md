...
language: csharp
---
Run a simple Csharp sample on DragonBoard 410c device running Windows 10 IoT Core
===
---
...
This document describes how to connect **DragonBoard 410c** device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](https://www.arrow.com/en/campaigns/the-dragonboard-is-here).
