...
Run a simple Csharp sample on SI-12 device running Windows 10 Enterprise LTSB
===
---
...
###Install Windows 10 Enterprise LTSB on SI-12
...
-   Insert the bootable USB Drive from the previous step into your SI-12. Turn on your SI-12 device and press the **Delete** key.
-   Change the BIOS Boot option filter to **Boot**.
-   Change the **Boot Option Priorities** to boot from your USB Drive.
-   Save changes and restart your device. Follow on screen instructions to install Windows Operating System on your SI-12.
