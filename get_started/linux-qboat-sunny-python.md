...
Run a simple Python sample on QBoat Sunny device running Ubuntu 14.04.1 LTS
===
---
...
-   Connect QBoat Sunny and your computer to internet
...
-   Install the prerequisite packages for the Microsoft Azure IoT Device SDK for Python by issuing the following commands from the command line on your board:
    ...
    -    Install dependents:
                ...
                apt install -y curl libcurl4-openssl-dev build-essential cmake git python2.7-dev libboost-python-dev
