...
Run a simple C sample on UP-GWS01 device running Ubuntu 16.04.2
===
---
...
This document describes how to connect UP-GWS01 device running Ubuntu 16.04.2 with Azure IoT SDK. This multi-step process includes:
...
-   Enter UP-GWS01 product page(http://www.aaeon.com/en/p/tiny-gateway-system-with-upboard) download manual and start UP-GWS01 follow the instructions and install the Windows 10 operating system.
