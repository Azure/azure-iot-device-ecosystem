...
language: csharp
---
Run a simple Csharp sample on EPC-T1217 device running Windows 10
===
---
...
This document describes how to connect EPC-T1217 device running Windows 10 with Azure IoT SDK. This multi-step process includes:
