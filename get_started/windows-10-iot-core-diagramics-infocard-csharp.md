...
device: diagramics infocard
language: csharp
---

Run a simple Csharp sample on Diagramics InfoCard&trade; device running Windows 10 IoT Core
===
---
...
This document describes how to connect Diagramics InfoCard&trade; device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
...
-   Diagramics InfoCard&trade; device.
...
-   A Compute Card docking station (for example, Intel Compute Card Dock DK132EPJ)

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Follow the instructions [here](http://www.diagramics.com/Products/InfoCard)
