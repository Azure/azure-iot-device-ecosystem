...
The following document describes the process of connecting an HoneyBee Repeater system to Azure IoT Hub.This multi-step process includes:
...
-  Connect the HoneyBee Repeater using the mini-USB cable.
...
This section shows you how to set up a development environment for the Azure IoT device SDK for C on HoneyBee Repeater.
...
On the HoneyBee Repeater device, install the ca-certificates package like below:
