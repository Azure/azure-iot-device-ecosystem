...
device: wall mount ipc
language: c
---

Run a simple C sample on Wall Mount IPC  device running Windows 10 IoT Enterprise LTSB
===
---
...
This document describes how to connect Wall Mount IPC device running Windows 10 IoT Enterprise LTSB with Azure IoT SDK. This multi-step process includes:
...
-   Insert the bootable USB Drive from the previous step into your Wall Mount IPC. Turn on your Wall Mount IPC  device and press the Delete key.
-   Change the BIOS Boot option filter to UEFI and Legacy.
-   Change the BIOS OS Selection to "Windows 10".
-   Change the Boot Option Priorities to boot from your USB Drive.
-   Save changes and restart your Wall Mount IPC . Follow on screen instructions to install Windows Operating System on your Wall Mount IPC .
