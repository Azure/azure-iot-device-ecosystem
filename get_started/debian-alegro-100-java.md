...
Run a simple JAVA sample on Alegro 100 device running Debian
===
---
...
This document describes how to connect Alegro 100 device running Debian with Azure IoT SDK. This multi-step process includes:
