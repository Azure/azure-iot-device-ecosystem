...
Run a simple C sample on AIIS device family running Linux
===
---
...
**About this document**
This document describes how to connect AIIS device family running Linux with Azure IoT SDK. This multi-step process includes:
