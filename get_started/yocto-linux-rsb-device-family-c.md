...
device: rsb device family
language: c
---

Run a simple C sample on RSB device family device running Yocto Linux
===
---
...
This document describes how to connect RSB device family device running Yocto Linux with Azure IoT SDK. This multi-step process includes:
...
-   Device from RSB family.

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device
-   Install Yocto Linux on your device.
