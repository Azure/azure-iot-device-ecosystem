...
Run a simple Csharp sample on EDA8909 device running Windows 10
===
---
...
This document describes how to connect **EDA8909** device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](http://www.usish.com).
