...
Run a simple C sample on SOM-6X50 device running Linux (Debian)
===
---
...
This document describes how to connect SOM-6X50 device running Linux (Debian) with Azure IoT SDK. This multi-step process includes:
