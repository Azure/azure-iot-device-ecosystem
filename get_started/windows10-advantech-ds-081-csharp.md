...
language: csharp
---
Run a simple Csharp sample on DS-081 device running Windows 10
===
---
...
This document describes how to connect DS-081 device running Windows 10 with Azure IoT SDK. This multi-step process includes:
