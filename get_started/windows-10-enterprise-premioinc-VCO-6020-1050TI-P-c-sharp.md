...
device: vco-6020-1050ti-p gpu computer
language: csharp
---

Run a simple Csharp sample on VCO-6020-1050TI-P GPU Computer device running Windows 10 Enterprise LTSC
===
---
...
This document describes how to connect VCO-6020-1050TI-P GPU Computer device running Windows 10 Enterprise LTSC with Azure IoT SDK. This multi-step process includes:
