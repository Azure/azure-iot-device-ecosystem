...
language: csharp
---
Run a simple Csharp sample on DPX-S435 device running Windows 10
===
---
...
This document describes how to connect DPX-S435 device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](http://www2.advantech.com/products/search.aspx?keyword=dpx-s435).
