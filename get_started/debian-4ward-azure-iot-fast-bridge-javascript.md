...
device: 4ward azure iot fast bridge
language: javascript
---

Run a simple JavaScript sample on 4ward Azure IoT Fast Bridge device running Debian
===
---
...
This document describes how to connect 4ward Azure IoT Fast Bridge device running Debian with Azure IoT SDK. This multi-step process includes:
...
-   Follow [here](http://www.4ward.it/iot-bridge/)
