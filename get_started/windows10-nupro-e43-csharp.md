...
language: csharp
---
Run a simple Csharp sample on NuPRO-E43 device running Windows 10
===
---
...
This document describes how to connect **NuPRO-E43** device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](http://www.adlinktech.com/index.php).
