...
Run a simple python sample on M101S device running Windows 10
===
---
...
This document describes how to connect M101S device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Open the file **iothub\_client_sample\_amqp.py**, **iothub\_client\_sample\_http.py** or  **iothub\_client\_sample\_mqtt.py** in a text editor.
