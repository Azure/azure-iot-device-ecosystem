...
device: diagramics smart display
language: csharp
---

Run a simple Csharp sample on Diagramics Smart Display device running Windows 10 IoT Core
===
---
...
This document describes how to connect Diagramics Smart Display device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
...
-   Diagramics Smart Display device.
