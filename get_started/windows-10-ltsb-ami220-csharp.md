...
Run a simple Csharp sample on AMI220 device running Windows 10 LTSB
===
---
...
This document describes how to connect AMI220 device running Windows 10 LTSB with Azure IoT SDK. This multi-step process includes:
...
-   Insert the bootable USB Drive from the previous step into your AMI220. Turn on your AMI220 device and press the **Delete** key.
-   Change the BIOS Boot option filter to “**Boot**”.
-   Change the “**Boot Option Priorities**” to boot from your USB Drive.
-   Save changes and restart your AMI220. Follow on screen instructions to install Windows Operating System on your AMI220.
-   In AMI220, install the latest .NET Core from <https://dot.net>
-   In AMI220, install .NET Framework 4.7 Developer Pack:
   
     <https://support.microsoft.com/en-us/help/3186612/the-net-framework-4-7-developer-pack-and-language-packs>

-   In AMI220, install .NET Framework 4.5.1 Developer Pack: 

     <https://www.microsoft.com/en-us/download/details.aspx?id=40772>

-   In AMI220, as admin (one-time setup): Enable Powershell script execution on your system. See <http://go.microsoft.com/fwlink/?LinkID=135170> for more information. 
