...
Run a simple C sample on ASMB device family running Yocto Linux
===
---
...
This document describes how to connect ASMB device family running Yocto Linux with Azure IoT SDK. This multi-step process includes:
