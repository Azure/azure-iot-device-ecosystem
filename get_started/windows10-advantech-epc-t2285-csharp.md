...
language: csharp
---
Run a simple Csharp sample on EPC-T2285 device running Windows 10
===
---
...
This document describes how to connect EPC-T2285 device running Windows 10 with Azure IoT SDK. This multi-step process includes:
