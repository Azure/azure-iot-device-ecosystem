...
Run a simple python sample on M900P device running Windows 10 IoT Enterprise
===
---
...
This document describes how to connect M900P device running Windows 10 IoT Enterprise with Azure IoT SDK. This multi-step process includes:
...
-   Open the file **iothub\_client\_sample_amqp.py**, **iothub\_client\_sample\_http.py** or  **iothub\_client\_sample\_mqtt.py** in a text editor.
