...
Run a simple PYTHON sample on IGT-31 device running debian 9
===
---
...
This document describes how to connect IGT-31 device running debian with Azure IoT SDK. This multi-step process includes:
...
-   IGT-31 device.
-	Open-wired RS-232 cable for accessing console port of IGT-31.
-   Terminal client on your desktop, such as [PuTTY](http://www.putty.org/).

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device
-	Follow the [instruction](http://www.automation.iiot.tw/en/unbox-neousys-iot-gateway-igt20/connect-to-igt-20-via-console-port) to log in to IGT-31
