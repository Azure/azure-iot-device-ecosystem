---
platform: arduino
device: four node smart switch 
language: c
---

Run a simple C sample on Four Node Smart Switch  device running Arduino
===
---
...
This document describes how to connect Four Node Smart Switch device running Arduino with Azure IoT SDK. This multi-step process includes:
...
-   Four Node Smart Switch device.
-   Mobile Application with ZYLFI apk 

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Power up the device by connecting the Line voltage to L and N in the module 
-   Observe the LED glowing the Hardware 
-   Press the setup switch on the Hardware to pair the device with mobile 
-   Open the ZYLFI mobile application go to **settings-->Device Settings-->Select the Room** and click **+** icon on top right corner.
-   Device Add page will open ,please select the WI-Fi available in the home from the dropdown menu.
-   Select the device, Enter the device name and click Next. (At this point Azure IoT connection string and other parameters will be passed to the device, since device is paired with mobile application) .
-   You will end with the Appliance page, please enter the channel vs appliances name. EX: channel 1 — FAN, Channel 2 – Ceiling Light .
-   Click Save. Your device is ready to operate from the Mobile application.

If any body wanted to run own Firmware. Please follow the below process .
...
1.  Build the SDK using following command. If you are facing any issues during build.
