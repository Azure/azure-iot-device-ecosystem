...
Run a simple C sample on RUTX10 device running RUTOS
===
---
...
This document describes how to connect RUTX10 device running RUTOS with Azure IoT SDK. This multi-step process includes:
