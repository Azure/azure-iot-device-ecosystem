...
Run a simple Csharp sample on NIFE105 device running windows 10
===
---
...
This document describes how to connect NIEF105 device running Windows 10 with Azure IoT SDK. This multi-step process includes:
-   Configuring Azure IoT Hub
-   Registering your IoT device
-   Build and deploy NIEF105 on device
...
-   Follow the instructions from [device website](https://developer.microsoft.com/en-us/windows/iot/GetStarted/Prototype/SetupDevice.htm).
<a name="Build"></a>
