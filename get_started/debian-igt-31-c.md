...
Run a simple C sample on IGT-31 device running Debian 9
===
---
...
This document describes how to connect IGT-31 device running Debian 9 with Azure IoT SDK. This multi-step process includes:
...
-   Follow the [instruction](https://www.automation.iiot.tw/en/unbox-neousys-iot-gateway-igt20/connect-to-igt-20-via-console-port) to log in to IGT-31
