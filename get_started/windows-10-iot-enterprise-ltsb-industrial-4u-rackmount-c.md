...
device: industrial 4u rackmount
language: c
---

Run a simple C sample on Industrial 4U RackMount device running Windows 10 IoT Enterprise LTSB
===
---
...
This document describes how to connect Industrial 4U RackMount device running Windows 10 IoT Enterprise LTSB with Azure IoT SDK. This multi-step process includes:
...
-   Industrial 4U RackMount device.   
...
-   Insert the bootable USB Drive from the previous step into your Industrial 4U RackMount. Turn on your Industrial 4U RackMount device and press the Delete key.
-   Change the BIOS Boot option filter to UEFI and Legacy.
-   Change the BIOS OS Selection to "Windows 10".
-   Change the Boot Option Priorities to boot from your USB Drive.
-   Save changes and restart your Industrial 4U RackMount. Follow on screen instructions to install Windows Operating System on your Industrial 4U RackMount.
