...
Run a simple Csharp sample on BOXER-6614 device running Windows 10
===
---
...
This document describes how to connect BOXER-6614 device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Enter BOXER-6614 product page(http://www.aaeon.com/en/p/fanless-embedded-computers-boxer-6614/) download manual and start BOXER-6614 follow the instructions and install the Windows10 operating system.
