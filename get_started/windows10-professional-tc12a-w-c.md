...
Run a simple C sample on TC12A-W device running Windows 10 Professional
===
---
...
This document describes how to connect TC12A-W device running Windows 10 Professional with Azure IoT SDK. This multi-step process includes:
...
-   Connect Ethernet cable to the WAN port on TC12A-W device and connect the other end to your switch/hub/router.
-   Connect a USB Keyboard and Mouse to the back USB ports of your TC12A-W device. Using an HDMI cable (The maximum supported screen resolution is 1280 x 1024 or 1920 x 1080 (depends on models)), also connect a monitor to the device.
