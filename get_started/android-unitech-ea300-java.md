---
platform: android
device: unitech ea300
language: java
---

Run a simple JAVA sample on unitech EA300 running Android
===
---
...
This document describes how to connect unitech EA300 with Azure IoT SDK. This multi-step process includes:
