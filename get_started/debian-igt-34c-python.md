...
Run a simple PYTHON sample on IGT-34C device running debian 9
===
---
...
This document describes how to connect IGT-34C device running debian with Azure IoT SDK. This multi-step process includes:
...
-   IGT-34C device.
-   Open-wired RS-232 cable for accessing console port of IGT-34C.
-   Terminal client on your desktop, such as [PuTTY](http://www.putty.org/).

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device
-	Follow the [instruction](http://www.automation.iiot.tw/en/unbox-neousys-iot-gateway-igt20/connect-to-igt-20-via-console-port) to log in to IGT-34C
...
-   Install the prerequisite packages for the Microsoft Azure IoT Device SDK for Python by issuing the following commands from the command line on your board:
        ...
        sudo apt-get update
        sudo apt-get install -y curl libcurl4-openssl-dev build-essential cmake git python2.7-dev libboost-python-dev uuid-dev
