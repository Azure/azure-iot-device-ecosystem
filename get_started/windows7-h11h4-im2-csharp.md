...
Run a simple CSharp sample on H11H4-IM2 device running Windows 7 Ultimate
===
---
...
This document describes how to connect H11H4-IM2 device running Windows 7 Ultimate with Azure IoT SDK. This multi-step process includes:
...
-  	Connect Ethernet cable to the WAN port on H11H4-IM2 device and connect the other end to your switch/hub/router.

-	Connect a USB Keyboard and Mouse to the back USB ports of your H11H4-IM2 device. Using an VGA cable, also connect a monitor to the device.
