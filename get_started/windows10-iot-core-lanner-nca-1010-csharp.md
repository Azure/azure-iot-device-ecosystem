...
device: lanner nca-1010
language: csharp
---
Run a simple Csharp sample on Lanner NCA-1010 device running Windows 10 IoT Core
===
---
...
This document describes how to connect Lanner NCA-1010 device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
...
-   Since NCA-1010 is a headless device, a VGA header cable is needed to connect to VGA pin head on NCA-1010 motherboard. 
