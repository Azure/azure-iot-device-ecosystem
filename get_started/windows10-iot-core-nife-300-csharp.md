...
Run a simple Csharp sample on NIFE-300 device running Windows 10 IoT Core
===
---
...
This document describes how to connect NIFE-300 device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
