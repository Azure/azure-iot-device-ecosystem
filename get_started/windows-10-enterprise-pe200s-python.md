...
Run a simple python sample on ASUS PE200S device running Windows IoT Enterprise
===
---
...
This document describes how to connect ASUS PE200S device running Windows IoT Enterprise with Azure IoT SDK. This multi-step process includes:
