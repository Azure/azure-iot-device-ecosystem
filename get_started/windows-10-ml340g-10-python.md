...
Run a simple python sample on your ML340G-10 device running Windows 10
===
---
...
This document describes how to connect your ML340G-10 device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   If you did not purchase your ML340G-10 with Windows 10, follow the instructions below.
-	Obtain and [install Windows 10 from a USB drive][lnk-install-windows-10].
-	[Download][lnk-install-drivers] and install the system drivers.
...
[lnk-install-windows-10]: https://docs.microsoft.com/en-us/windows-hardware/manufacture/desktop/install-windows-from-a-usb-flash-drive
[lnk-install-drivers]: http://www.asrock.com/ipc/overview.asp?cat=Download&Model=SBC-220#osW1064
