...
Run a simple C sample on Zone Wing device running Linux
===
---
...
This document describes how to build and run a sample c application on the Zone Wing device running Linux. This multi-step process includes:
...
-   Plug in the 12v charger to the Zone Wing device and connect it to the internet.
