...
Run a simple C sample on IKON-3200 device running Windows 7 Professional K with Azure IoT SDK.
===
---
...
This document describes how to connect IKON-3200 device running Windows 7 Professional K with Azure IoT SDK. This multi-step process includes:
...
-   IKON-3200 device.
-   http://www.4cgate.com/html_15_kor/06_hardware_a01.htm
...
-   Locate the following code in the file:
        ...
        static const char* connectionString = "HostName=AzureCertWin-FC.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=wdGlVz9RbqZHre6BjaCcVKl6l9/x5Z+g5prBhM+YBXg=";
