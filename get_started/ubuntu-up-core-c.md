...
Run a simple C sample on UP-Core device running Ubuntu 16.04.2
===
---
...
This document describes how to connect UP-Core device running Ubuntu 16.04.2 with Azure IoT SDK. This multi-step process includes:
...
-   Enter UP-Core product page <http://www.aaeon.com/en/p/iot-gateway-maker-boards-up-core> download manual and start UP-Core follow the instructions and install the Linux operating system.
