...
Run a simple C sample on AIOT-ILRA01 device running Ubuntu 16.04.2
===
---
...
This document describes how to connect AIOT-ILRA01 device running Ubuntu 16.04.2 with Azure IoT SDK. This multi-step process includes:
...
-   Enter AIOT-ILRA01 product page(http://www.aaeon.com/en/p/intel-lora-gateway-system-server) download manual and start AIOT-ILRA01 follow the instructions and install the Linux operating system.
