...
Run a simple Csharp sample on KUBE-5500 device running Windows 10
===
---
...
This document describes how to connect KUBE-5500 device running Windows 10 with Azure IoT SDK. This multi-step process includes:
