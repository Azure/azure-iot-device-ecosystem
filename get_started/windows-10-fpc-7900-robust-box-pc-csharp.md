---
platform: windows 10
device: fpc-7900 robust box pc
language: csharp
---

Run a simple Csharp sample on FPC-7900 Robust Box PC device running Windows 10
===
---
...
This document describes how to connect FPC-7900 Robust Box PC device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   FPC-7900 Robust Box PC device.

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Follow the instructions from [device website](https://www.arbor-technology.com/gl/Product/Pro/Model/FPC-7900);
