...
Run a simple C sample on UPOS device family running Yocto Linux
===
---
...
This document describes how to connect UPOS device family running Yocto Linux with Azure IoT SDK. This multi-step process includes:
