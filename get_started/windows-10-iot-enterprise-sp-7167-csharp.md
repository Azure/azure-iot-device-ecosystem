...
Run a simple Csharp sample on SP-7167 device running Windows 10 IoT Enterprise
===
---
...
This document describes how to connect SP-7167 device running Windows 10 IoT Enterprise with Azure IoT SDK. This multi-step process includes:
...
-   Power on SP-7167 (Windows 10 Enterprise).
...
-   Connect the SP-7167 to your network using an Ethernet cable. This step is required, as the sample depends on internet access
