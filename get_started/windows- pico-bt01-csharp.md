...
-   See [Manage IoT Hub][lnk-manage-iot-hub] to learn how to observe the messages IoT Hub receives from the **Device Client AMQP Sample** application and how to send cloud-to-device messages to the **Device Client AMQP Sample** application.
