---
platform: windows 10
device: iruggy h10 mobile tablet
language: csharp
---

Run a simple Csharp sample on iRUGGY H10 Mobile Tablet device running Windows 10
===
---
...
This document describes how to connect iRUGGY H10 Mobile Tablet device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   iRUGGY H10 Mobile Tablet device.

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Follow the instructions from [here](<http://www.iruggy.com/products/h10-mobile-tablet>).
