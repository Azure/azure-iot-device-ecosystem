...
---
Run a simple C sample on PCE device family running Linux
===
---
...
This document describes how to connect PCE device family running Linux with Azure IoT SDK. This multi-step process includes:
