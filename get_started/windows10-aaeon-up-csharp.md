...
Run a simple Csharp sample on AAEON UP device running Windows 10
===
---
...
This document describes how to connect AAEON UP device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](http://www.up-board.org/).
