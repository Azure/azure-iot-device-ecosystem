...
language: csharp
---
Run a simple Csharp sample on ARK-2151V device running Windows 10
===
---
...
This document describes how to connect ARK-2151V device running Windows 10 with Azure IoT SDK. This multi-step process includes:
