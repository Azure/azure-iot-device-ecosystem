...
device: openblocks idm appliance
language: c
---

Run a simple C sample on OpenBlocks IDM Appliance device running Debian GNU/Linux 8
===
---
...
This document describes how to connect OpenBlocks IDM Appliance device running Debian GNU/Linux 8 with Azure IoT SDK. This multi-step process includes:
...
-   OpenBlocks IDM Appliance device.
-   Attached console cable.
-   Terminal emulator that can use RS-232C.
-   USB RS232 convert cable.

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device
-   Connect the console cable and start the terminal emulator. (115200 Boau, 8-bit, Non-parity)
-   Login as root (The password is in the manual.)
-   Inital setup with 'obsidm_setup.sh' command.
...
-   Edit the following file using any text editor of your choice:
    ...
    **For WebSocket with AMQP protocol:**
        ...
        vi azure-iot-sdk-c/iothub_client/samples/iothub_client_sample_amqp_websockets/iothub_client_sample_amqp_websockets.c

    **For WebSocket with AMQP protocol:**

        vi azure-iot-sdk-c/iothub_client/samples/iothub_client_sample_mqtt_websockets/iothub_client_sample_mqtt_ws.c
...
-   Run the sample by issuing following command:
    ...
    **If using WebSocket with AMQP protocol: Run sample iothub_client_sample_amqp_websocket:**
    ...
    **If using WebSocket with MQTT protocol: Run sample iothub_client_sample_mqtt_websocket:**
