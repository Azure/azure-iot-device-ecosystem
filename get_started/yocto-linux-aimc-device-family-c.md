...
Run a simple C sample on AIMC device family running Yocto Linux
===
---
...
This document describes how to connect AIMC device family running Yocto Linux with Azure IoT SDK. This multi-step process includes:
