...
Run a simple JAVA sample on ALTA DS 3 running Android
===
---
...
This document describes how to connect ALTA DS 3 with Azure IoT SDK. This multi-step process includes:
...
2.  Go to MainActivity.java, replace the [device connection string] placeholder with connection string of the device you have created in Provision your device and get its credentials and save the file. An example of IoT Hub Connection String is as below:
        ...
        HostName=[YourIoTHubName];[YourIoTDeviceName];SharedAccessKeyName=[YourAccessKeyName];SharedAccessKey=[YourAccessKey]
        EX: HostName=aics-prod-hub.azure-devices.net;DeviceId=Hl9O7Trfze;SharedAccessKey=JkN+QgWr4f1EmFmQ8bRRkrizXWYlciFuK2ZNpK/pXw0=
