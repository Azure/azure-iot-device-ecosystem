...
Run a simple Csharp sample on NISE 50C-H device running Windows 10 IoT Core
===
---
...
This document describes how to connect NISE 50C-H device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
