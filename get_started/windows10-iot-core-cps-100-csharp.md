...
Run a simple Csharp sample on CPS-100 device running Windows 10 IoT Core
===
---
...
This document describes how to connect CPS-100 device running Windows 10 IoT Core with Azure IoT SDK. This multi-step process includes:
