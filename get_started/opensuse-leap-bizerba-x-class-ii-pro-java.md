---
platform: opensuse leap 42.2
device: bizerba x-class ii pro
language: java
---

Run a simple JAVA sample on Bizerba X-Class II Pro device running openSUSE Leap 42.2
===
---
...
This document describes how to connect Bizerba X-Class II Pro device running openSUSE Leap 42.2 with Azure IoT SDK. This multi-step process includes:
...
-   Bizerba XC2 Pro device.

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   openSUSE Leap 42.2 is already pre-installed 
...
1.  Run the below command to install Java SDK
...
5.  Make sure that the JAVA\_HOME environment variable includes the full path to the JDK. Use below command to get the JDK path.
...
7.  Run the following command to set **JAVA\_HOME** environment variable.
...
1.  Run below commands to install Maven
  
        wget http://www-us.apache.org/dist/maven/maven-3/3.5.4/binaries/apache-maven-3.5.4-bin.tar.gz
        sudo tar -xvzf apache-maven-3.5.4-bin.tar.gz -C /opt
...
4.  Above command will generate the compiled JAR files with all dependencies. This bundle can be found at:
        ...
        azure-iot-sdk-java/device/iothub-java-client/target/iothub-java-client-{version}.jar
...
-   Navigate to the folder containing the executable JAR file for send event sample.
        ...
        cd azure-iot-sdk-java/device/iot-device-samples/samples/send-event/target
