...
device: sp5000 open box
language: csharp
---

Run a simple Csharp sample on SP5000 Open Box device running Windows Embedded Standard 7
===
---
...
This document describes how to connect SP5000 Open Box device running Windows Embedded Standard 7 with Azure IoT SDK. This multi-step process includes:
...
-   [SP5000 Open Box device](https://www.proface.com/en/product/hmi/sp5000/top)

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Connect the power adapter, USB Keyborad/Mouse with SP5000 Open Box.
-   Power on your SP5000 Open Box and connect to the Internet.
-   Setup Windows.
