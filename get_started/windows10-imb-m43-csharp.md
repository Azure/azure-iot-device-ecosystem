...
Run a simple Csharp sample on IMB-M43 device running Windows 10
===
---
...
This document describes how to connect **IMB-M43** device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](http://www.adlinktech.com/PD/web/PD_detail.php?cKind=&pid=1600&seq=&id=&sid=&category=Industrial-Motherboards-&-SBC_%20ATX&utm_source=#).
