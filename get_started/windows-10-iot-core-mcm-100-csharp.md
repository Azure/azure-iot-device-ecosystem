...
Run a simple C# sample on MCM-100 device running Windows 10 IoT Core
===
---
...
This document describes how to connect MCM-100 device running Windows 10 IoT Core with Azure IoT Edge Runtime pre-installed and Device Management. This multi-step process includes:
