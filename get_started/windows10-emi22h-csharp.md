...
Run a simple Csharp sample on EMI22H device running Windows 10
===
---
...
This document describes how to connect EMI22H device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Follow the instructions from [device website](http://info.emdoor.com/Custom_Products.asp?ID=53&amp;nav=2).
