...
Run a simple Csharp sample on NEC FC-P33W device running Windows 10 IoT Enterprise
===
---
...
This document describes how to connect NEC FC-P33W device running Windows 10 IoT Enterprise with Azure IoT SDK. This multi-step process includes:
...
-  You will need to have the NEC FC-P33W configured with Setting to be on Developer Mode. Please refer [here](https://docs.microsoft.com/en-us/windows/uwp/get-started/enable-your-device-for-development) for details.
