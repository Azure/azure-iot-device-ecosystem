---
platform: windows 10
device: avalue vms-cfs
language: csharp
---

Run a simple Csharp sample on Avalue VMS-CFS device running Windows 10
===
---
...
This document describes how to connect Avalue [VMS-CFS][device-link] device running Windows 10 with Azure IoT SDK. This multi-step process includes:
...
-   Avalue [VMS-CFS][device-link] device.
-   VGA Cable,USB Keyboard/Mouse, and the Internet connection

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   Connect the power adapter, USB Keyborad/Mouse with Avalue [VMS-CFS][device-link].
...
[device-link]: https://www.avalue.com.tw/products/Industrial-Computer/Transportation-System/Vehicle/VMS-CFS_2790